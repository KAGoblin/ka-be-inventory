"""
Django settings for ka_be_inventory project.
...
INSTALLED_APPS = [
    ...
    'ka_be_inventory.apps.inventory',
]
...
ROOT_URLCONF = 'ka_be_inventory.urls'
...
WSGI_APPLICATION = 'ka_be_inventory.wsgi.application'
...
# DEFAULT_TABLESPACE = 'ka_be_inventory'
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_PAGINATION_CLASS': 'ka_be_inventory.api.framework.pagination.CustomPagination',
    # 'PAGE_SIZE': 10,
    'MAX_PAGE_SIZE': 1500,
